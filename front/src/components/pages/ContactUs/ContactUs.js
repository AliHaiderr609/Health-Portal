          ...
          <div className="row">
            <div className="col-lg-6">
              ...
              <ul className="contact_about_list">
                <li><div className="contact_about_icon"><img src={PhoneCall} alt="" /></div><span>+45 677 8993000 223</span></li>
                <li><div className="contact_about_icon"><img src={Envelope} alt="" /></div><span>office@template.com</span></li>
                <li><div className="contact_about_icon"><img src={Placeholder} alt="" /></div><span>Main Str. no 45-46, b3, 56832, Los Angeles, CA</span></li>
              </ul>
            </div>
